...
def load_gnn_model(model_path='trained_models/gnn_model.pt', device='cpu'):
    ...
    # num_node_features must match TransactionGraphBuilder which creates
    # 3-dimensional one-hot features (account=0, merchant=1, device=2)
    model = FraudGNN(num_node_features=3, hidden_channels=64)
